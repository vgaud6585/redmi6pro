...
document.querySelector(".menu-bar-click").addEventListener("click", function () {
  // alert("ok");
  document.querySelector(".side-bar").style.left = 0 + "px";
})
document.querySelector(".side-bar").addEventListener("click", function () {
  document.querySelector(".side-bar").style.left = -80 + "%";
  
})


document.querySelector(".add-record").addEventListener("click", function () {
  document.querySelector(".new-code").style.display = "block";
})
document.querySelector(".register").addEventListener("click", function () {
  document.querySelector(".new-code").style.display = "none";
})

document.querySelector(".record-data").addEventListener("click", function () {
  document.querySelector(".all-codes").style.display = "none";
  document.querySelector(".record-new-data").style.display = "block";
  
} )
document.querySelector(".all-record").addEventListener("click", function () {
  document.querySelector(".all-codes").style.display = "block";
  document.querySelector(".record-new-data").style.display = "none";
